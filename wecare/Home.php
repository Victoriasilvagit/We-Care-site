...
<body>
     <header class="header">
         ...
         <div class="menu">
               <ul>
                   <li><a href="doações.html">Faça parte</a></li>
                   <li><a href="patrocine.html">Patrocine</a></li>
                   <li><a href="vc sabia.html">Você Sabia?</a></li>
     ...
     <div>
      ...
      <div class="titulo2">
        ...
        <button class="log  button-block">Cadastre-Se</button>
        </a>

        <a href="formlog.html">
         <button class="login  button-block">Faça login</button> 
        </a>
        </div>
